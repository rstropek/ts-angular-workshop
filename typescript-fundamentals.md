...
* Also note [*Type Guard*](https://www.typescriptlang.org/docs/handbook/advanced-types.html#type-guards-and-differentiating-types)

```
<!--#include file="typescript-fundamentals/0030-Interfaces-and-Classes/any-compat.ts" -->
```
